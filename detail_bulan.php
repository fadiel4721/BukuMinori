...
// Dapatkan parameter bulan dari URL
$bulan = isset($_GET['bulan']) ? $_GET['bulan'] : date('Y-m-d');

// Query untuk mendapatkan detail tamu pada bulan tertentu
$query = "SELECT history.*, tamu.nama_tamu, tamu.jk, tamu.no_hp, tamu.alamat, tamu.email_tamu
          ...
          WHERE MONTH(history.waktu_datang) = MONTH('$bulan') AND YEAR(history.waktu_datang) = YEAR('$bulan')";
...
<body>
    ...
    <section class="home">
        <div class="text">
            <i class='bx bx-calendar'></i> Detail Tamu Bulan Ini (<?php echo $bulan; ?>)
        </div>
